...
def make_args():
    ...
    parser.add_argument('--dataset', dest='dataset', default='All', type=str,
                        help='udbms')
    parser.add_argument('--dataset_duplicates', dest='dataset_duplicates',
                        default='person_duplicate_without_subject_feat.map', type=str,
                        help='file for duplicate mapping')
    ...
    parser.add_argument('--feature_dim', dest='feature_dim', default=433, type=int)  # 32
    parser.add_argument('--hidden_dim', dest='hidden_dim', default=121, type=int)  # 32
    parser.add_argument('--output_dim', dest='output_dim', default=121, type=int)  # 32
    ...
    parser.add_argument('--lr', dest='lr', default=1e-4, type=float)  # 1e-2
    ...
    parser.set_defaults(gpu=True, task='similarity', model='PGNN', dataset='duplicate_without_subject_featudbms',
                        dataset_duplicates='person_duplicate_without_subject_feat.map', cache=True,
                        rm_feature=False, permute=True, feature_pre=True, dropout=True,
