...
def get_tg_dataset(args, dataset_name, inference=False, selected_features_set={}):
    """
    ...
    """
    try:
        dataset = load_tg_dataset(dataset_name, args.dataset_duplicates, selected_features_set=selected_features_set)
    except:
    ...
    f1_name = '../pgnn/datasets/cache/' + dataset_name + str(args.approximate) + '_duplicates_train.dat'
    f2_name = '../pgnn/datasets/cache/' + dataset_name + str(args.approximate) + '_duplicates_val.dat'
    f3_name = '../pgnn/datasets/cache/' + dataset_name + str(args.approximate) + '_duplicates_test.dat'
    f4_name = '../pgnn/datasets/cache/' + dataset_name + str(args.approximate) + '_duplicates_train_neg.dat'
    f5_name = '../pgnn/datasets/cache/' + dataset_name + str(args.approximate) + '_duplicates_val_neg.dat'
    f6_name = '../pgnn/datasets/cache/' + dataset_name + str(args.approximate) + '_duplicates_test_neg.dat'
